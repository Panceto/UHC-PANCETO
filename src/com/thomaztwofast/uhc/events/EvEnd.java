...
public class EvEnd implements Listener {
	...
	private List<String> title = Arrays.asList("15|Se acabo y perdiste sientete mal, BASURA", "", "5|UHC Sancheto");
	...
	public EvEnd(Main pl, String winner) {
		...
		title.set(1, "30|LOS GANADORES DE LA PRIMERA EDICIÓN DE UHC SANCHETO SON: " + winner);
